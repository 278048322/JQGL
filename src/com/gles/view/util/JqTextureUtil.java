 ...
 * 纹理生成工具<br>
 * <p>
 * 注意点：使用到的纹理图片 宽与高必须为 2的n次方的尺寸的图片，不然会出现无法正常显示等问题！<br>
 * 
...
public class JqTextureUtil {
	 ...
	 * @return
	 */
	public static float[] generateTexCoor(int bw, int bh, float widthLength,
			float heightLength) {
		float[] result = new float[bw * bh * 6 * 2];
		float sizew = widthLength / bw;// 列数
		float sizeh = heightLength / bh;// 行数
		int c = 0;
		for (int i = 0; i < bh; i++) {
			for (int j = 0; j < bw; j++) {
